...
import { donHangRoutes } from '../api/api-router';
...
export class DonHangApiService {
  ...
  getAll(): Observable<any> {
    return this.http.get(environment.api.baseUrl + donHangRoutes.getAll+"?idKh="+0);
  }
  ...
  getDonHangByMa(maDonHang: any): Observable<any> {
    return this.http.post(environment.api.baseUrl + donHangRoutes.updateStatus+ "?maDonHang="+maDonHang);
  }
}

...
export class LichSuDonHangApiService {
  ...
  getDonDangForShiper(id: any, trangThai: any): Observable<any> {
    return this.http.get(environment.api.baseUrl + lichSuDonHangRoutes.getForShipper + "?idUser=" + id + "&trangThai="+ trangThai);
  }
}
